---
address: 1MockMiner003XXXXXXXXXXXXXXXXXXXXX
...
Activity ran from block 21,997 to block 876,000 — across 854,003 blocks of chain history. Per-block activity sidecars (where this wallet appears) live under `vault/activity/`.
