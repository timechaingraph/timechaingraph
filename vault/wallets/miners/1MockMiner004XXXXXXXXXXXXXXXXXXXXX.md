---
address: 1MockMiner004XXXXXXXXXXXXXXXXXXXXX
...
Activity ran from block 32,946 to block 876,000 — across 843,054 blocks of chain history. Per-block activity sidecars (where this wallet appears) live under `vault/activity/`.
